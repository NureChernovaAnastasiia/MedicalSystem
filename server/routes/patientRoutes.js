...
router.put("/:id/photo", authMiddleware, checkRole("Patient"), patientController.updatePhoto);
...
router.put('/:id', checkRole('Doctor', 'Admin', 'Patient'), patientController.update.bind(patientController));
