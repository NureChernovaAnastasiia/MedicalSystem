import { ABOUTUS_ROUTE, ADMIN_PANEL_ROUTE, DOCTOR_ALLAPPOINTMENTS_ROUTE, DOCTOR_APPOINTMENTS_ROUTE, DOCTOR_HOSPITALDETAILS_ROUTE, DOCTOR_PANEL_ROUTE, DOCTOR_PATIENTS_ROUTE, DOCTOR_SERVICES_ROUTE, LOGIN_ROUTE, MAIN_ROUTE, PATIENT_ANALYSEDETAIL_ROUTE, PATIENT_ANALYSEORDER_ROUTE, PATIENT_ANALYSIS_ROUTE, PATIENT_APPOINTMENTS_ROUTE, PATIENT_DOCAPPOINTMENT_ROUTE, PATIENT_DOCSCHEDULE_ROUTE, PATIENT_EDITPERSONALINFO_ROUTE, PATIENT_HOSPITALDETAIL_ROUTE, PATIENT_HOSPITALSCHEDULE_ROUTE, PATIENT_MEDCARD_ROUTE, PATIENT_MEDDETAIL_ROUTE, PATIENT_MEDRECORDS_ROUTE, PATIENT_PANEL_ROUTE, PATIENT_PRESCRIPTIONS_ROUTE, PATIENT_SERVICE_ROUTE, PATIENT_SERVICEDETAILS_ROUTE, PATIENT_SERVICEORDER_ROUTE, SERVICES_ROUTE } from "./utils/consts";
